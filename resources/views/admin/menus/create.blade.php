            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative group">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Contoh: Nasi Goreng Spesial, Latte Art" required
                ...
                <div>
                    ...
                    <div class="relative group">
                        ...
                        {{-- Menggunakan type="text" dan onkeyup --}}
                ...
                <div class="md:col-span-2">
                    <label for="image" class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-2">Foto Menu</label>
