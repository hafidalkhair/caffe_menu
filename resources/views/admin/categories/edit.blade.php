...
@section('content')
    ...
    <div class="max-w-3xl mx-auto mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 fade-in-up">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Perbarui informasi kategori menu yang sudah ada.</p>
        </div>
    ...
    <div class="max-w-3xl mx-auto bg-white rounded-2xl shadow-sm border border-gray-100 p-8 fade-in-up" style="animation-delay: 0.1s;">
        ...
        <div class="flex items-center gap-4 mb-8 pb-6 border-b border-gray-50">
            ...
            <div>
                ...
                <p class="text-xs text-gray-500">ID Kategori: #{{ $category->id }}</p>
            </div>
        </div>
        ...
        <form action="{{ route('admin.categories.update', $category->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name', $category->name) }}" placeholder="Contoh: Makanan Berat" required
            ...
            <div>
                ...
                <div class="relative group">
                    ...
                    <textarea name="description" id="description" rows="4" placeholder="Jelaskan secara singkat tentang kategori ini..."
                        class="pl-11 block w-full rounded-xl border-gray-200 bg-gray-50 focus:bg-white text-gray-800 shadow-sm focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 sm:text-sm py-3 transition-all">{{ old('description', $category->description) }}</textarea>
                </div>
            ...
            <div class="pt-6 flex items-center justify-end gap-3 border-t border-gray-50">
                <a href="{{ route('admin.categories.index') }}" class="px-6 py-2.5 rounded-xl text-gray-500 hover:text-gray-700 hover:bg-gray-50 font-medium transition-colors">
                    Batal
                </a>
